...
import { basketActions, getBasket } from "../store/basket/baskekSlice";
...
function Header({ onShowBasket }) {
  ...
  const switchingThemes = () => {
    ...
    dispatch(basketActions.changeTheme(theme));
  };
...
const Container = styledComponent.header`
  ...
  z-index: 10;
  height: 101px;
  background: ${(props) => getThene(props.theme).palette.primary.main};
  display: flex;
...
const FormControlLabelTheme = styled(FormControlLabel)((themeMode) => ({
